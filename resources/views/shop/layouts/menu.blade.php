...
<div class="d-flex bd-highlight mb-3">
    ...
    <div class="p-2 bd-highlight pr-5">
        В корзине: % товаров <br>На сумму: 5000 руб
        <br>
        <div class="pt-2">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav center-block mx-auto">
                ...
                <li class="nav-item {{ Request::is('page/about') ? 'active' : '' }}">
                    <a class="nav-link" href="/page/about"><i class="fas fa-info-circle"></i> О магазине</a>
                </li>
                <li class="nav-item {{ Request::is('page/contacts') ? 'active' : '' }}">
                    <a class="nav-link" href="/page/contacts"><i class="fas fa-phone-square"></i> Контакты</a>
                </li>
